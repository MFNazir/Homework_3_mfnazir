...
class LineitemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create lineitem" do
    assert_difference('Lineitem.count') do
      post lineitems_url, params: { lineitem: { invoice_id: @lineitem.invoice_id, metalitem_id: @lineitem.metalitem_id } }
    end
  ...
  test "should update lineitem" do
    patch lineitem_url(@lineitem), params: { lineitem: { invoice_id: @lineitem.invoice_id, metalitem_id: @lineitem.metalitem_id } }
